...
//not superpositive this is the final.
...
contract Staker {
  ...
  //In public functions, Solidity immediately copies array arguments to memory, while external functions can read directly from calldata.
